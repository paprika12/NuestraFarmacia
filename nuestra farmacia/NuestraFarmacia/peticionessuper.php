	...
	$(document).ready(function () {
        jQuery('#grid').jqGrid({
				...
				"colModel":[
						...
						{"name":"Usuario","index":"Usuario","sorttype":"string","editable":true},
						{"name":"Estatus","index":"Estatus","sorttype":"string","editable":true},
						{"name":"Comentarios","index":"Comentarios","sorttype":"string","editable":true}
				],
			...
			jQuery("#grid").navGrid('#pager',{edit:false,add:false,del:false,search:false}).navButtonAdd('#pager',{
    						...
    						selRowId = myGrid.jqGrid ('getGridParam', 'selrow');
     						...
     						if (selRowId){
     							window.location="./validarpeticion.php?peticion="+selRowId;
     						}
     						else{
     							alert("Porfavor selecciona una fila")
     						}
   						}
			})
